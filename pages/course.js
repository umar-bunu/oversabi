        ...
        <div className={styles.header__body}>
          <div className={styles.course__header}>
            ...
            <p className={styles.header__paragraph}>
              Just Select Correct Options and Calculate Best Price!. Result is
              all that Matters!
            </p>
          </div>
          ...
          <div className={styles.course__body_content}>
            <div className={styles.assignment__form}>
              <h2 className={styles.header__heading2}>Your Email</h2>
              <input
            ...
            <div className={styles.assignment__form}>
              <h2 className={styles.header__heading2}>Academic Level</h2>
            ...
            <div className={styles.assignment__form}>
              <h2 className={styles.header__heading2}>Select Domain</h2>
            ...
            <div className={styles.assignment__form}>
              <h2 className={styles.header__heading2}>Desired Service</h2>
              <select
                required
                id="country"
                name="serviceType"
            ...
            <div className={styles.assignment__form}>
              <h2 className={styles.header__heading2}>Words/Pages</h2>
              <select required id="country" name="noOfWords">
                {selectedService == "Assignment" ||
                selectedService == "Coursework" ||
            ...
            <div className={styles.assignment__form}>
              <h2 className={styles.header__heading2}>Tools to use</h2>
            ...
            <div className={styles.assignment__form}>
              <h2 className={styles.header__heading2}>Whatsapp no</h2>
            ...
            <div className={styles.assignment__form}>
              <h2 className={styles.header__heading2}>Due date</h2>

              <input
                required
                placeholder="Deadine: dd/mm/yy"
                type="date"
                name="dueDate"
              />
            </div>
